...
A compilation of all paragraphs will also be saved to a `TXT` file. Some paragraphs might not be stored succesfully in the txt file due to current limitations that are being worked on. 

## Version history
- **v.0.07 - NOW USING ASYNCIO FOR MUCH FASTER REQUESTS**
